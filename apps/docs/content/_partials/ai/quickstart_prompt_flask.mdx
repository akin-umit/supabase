```text
Help me add Supabase to my Python Flask project. Create a Supabase project at database.new and
...
4. Create `app.py` with a Flask route that queries and renders the instruments table using the
   Supabase client.
