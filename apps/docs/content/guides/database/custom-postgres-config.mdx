...
| [max_logical_replication_workers](https://www.postgresql.org/docs/current/runtime-config-replication.html#GUC-MAX-LOGICAL-REPLICATION-WORKERS)                                                                                 | CLI only  | Yes     | `--config max_logical_replication_workers=10`  |
...
| [max_sync_workers_per_subscription](https://www.postgresql.org/docs/current/runtime-config-replication.html#GUC-MAX-SYNC-WORKERS-PER-SUBSCRIPTION)                                                                             | CLI only  | No      | `--config max_sync_workers_per_subscription=10`|
