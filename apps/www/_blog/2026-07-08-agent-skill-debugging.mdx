...
author: jordi
imgSocial: 2026-07-08-agent-skill-debugging/og.jpg
imgThumb: 2026-07-08-agent-skill-debugging/thumb.jpg
categories:
  - product
tags:
  - ai
...
The [Supabase agent skill](https://github.com/supabase/agent-skills) now includes a debugging workflow. [Install the skills in your agent](https://supabase.com/docs/guides/ai-tools/ai-skills), and when your agent hits a Supabase error it reproduces it, isolates the layer that caused it, and queries the logs for evidence, instead of scanning every log source and hoping something turns up.
