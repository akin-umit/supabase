...
tags:
  ...
  - monitoring
  - postgres
imgSocial: observability-for-every-supabase-project-with-grafana-cloud/grafana-og.png
imgThumb: observability-for-every-supabase-project-with-grafana-cloud/grafana-thumb.png
toc_depth: 2
---

The [Grafana Cloud integration](https://supabase.com/dashboard/project/_/integrations/grafana/overview) is available in Supabase. You've been able to connect Supabase to Grafana Cloud for years, and now you can connect to it instantly with the push of a button.
...
<div className="video-container">
  <iframe
    className="w-full"
    src="https://www.youtube-nocookie.com/embed/EDAi7JR6xRc"
    title="Observability for every Supabase project with Grafana Cloud"
...
→ [Connect your project to Grafana Cloud](https://supabase.com/dashboard/project/_/integrations/grafana/overview)
